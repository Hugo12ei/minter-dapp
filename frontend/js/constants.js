const contractAddress = "0xe2256Dc04c543949695a1A828C2A5b77634Fb4c8"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Tangible Tigers NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Tangible Tigers NFT Project is a decentralized, open-source project'
